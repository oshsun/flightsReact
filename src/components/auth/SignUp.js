    ...
    <Form onSubmit={submitHandler}>
      <div className='control-group'>
        <div className={usernameClasses}>
          ...
          />
          {usernameHasError && <p className="error-text">Please enter username.</p>}
        </div>
      ...
      <div className={passwordClasses}>
        ...
        />
        {passwordHasError && <p className="error-text">Password must contain at least 6 characters.</p>}
      </div>
